...
# 原图路径
path_ori = "/root/ConceptExpress/ckpts/69/69_con_ori_abs/attention/0-step/final_masked1.png"
# 图片文件夹路径
folder_path = "/root/ConceptExpress/output_69/seed_0/69_con_ori_abs_snow/a-photo-of-<asset1>-in-the-snow"
